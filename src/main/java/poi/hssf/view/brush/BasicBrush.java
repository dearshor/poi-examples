...
==================================================================== */
package poi.hssf.view.brush;

import java.awt.*;

/**
 * This is a basic brush that just draws the line with the given parameters.
 * This is a {@link java.awt.BasicStroke} object that can be used as a {@link Brush}.
 *
...
public class BasicBrush extends BasicStroke implements Brush {
     ...
     *
     * @see java.awt.BasicStroke#BasicStroke(float)
     */
     ...
     * {@link java.awt.BasicStroke#BasicStroke(float,int,int)}
     *
     * @param width The brush width.
     * @param cap   The capping style.
     * @param join  The join style.
     *
     * @see java.awt.BasicStroke#BasicStroke(float, int, int)
     */
     ...
     * java.awt.BasicStroke#BasicStroke(float,int,int,float,float[],float)} with a miter
