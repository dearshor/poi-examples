...
public class Msg2txt {
	 ...
	 * 
	 * @throws java.io.IOException if an exception occurs while writing the message out
	 */
	 ...
	 * @throws java.io.IOException when any of the file operations fails
	 */
